...
class records_manager implements records_manager_interface {
     ...
     */
    const TABLE_NAME = 'tool_spadaindonesia';

    /**
     * A name of the cache component.
     */
    const CACHE_COMPONENT = 'tool_spadaindonesia';
     ...
     *
     * @return \tool_spadaindonesia\record
     */
     ...
     *
     * @return \tool_spadaindonesia\record_interface[]
     */
