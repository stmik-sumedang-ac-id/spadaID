...
use \tool_spadaindonesia\records_manager;
 ...
 * @return bool
 */
function xmldb_tool_spadaindonesia_upgrade($oldversion) {
    global $CFG, $DB;

    if ($oldversion < 2021042801) {
        ...
        upgrade_plugin_savepoint(true, 2021042801, 'tool', 'spadaindonesia');
    }
